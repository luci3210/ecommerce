...
<section id="exclusive-section" class="my-3 container">
  <div class="row">
    <div class="col-md-6 col-sm-6 col-6 banners-effect-1">
      <img src="{{asset('ecom/bn1.jpg')}}" class="w-100" >
      <!-- <div class="card bn1">
          <div class="card-body">
    ...
    <div class="col-md-6 col-sm-6 col-6 banners-effect-1">
      <img src="{{asset('ecom/bn2.jpg')}}"  class="w-100">
    </div>
  </div>
...
<section id="exclusive-section" class="my-3 container">
  <div class="row g-0">
    ...
    <div class="col-md-4 col-sm-6 col-6 ">
      <div class="row">
        <div class="col-12 banners-effect-1 my-2 ">
    ...
    <div class="col-md-4 col-sm-6 col-6 banners-effect-1">
      <img class="float-end" src="{{asset('ecom/bn3.jpg')}}">
    </div>
  </div>
